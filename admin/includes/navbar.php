...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <img src="./img/plvdocxicon.png" height="45vh">
    </div>
    <div class="sidebar-brand-text mx-3">PLV ADMIN</div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="status_signature.php">Signature</a>
            <a class="collapse-item" href="status_torelease.php">To Release</a>
...
<li class="nav-item">
    ...
    <div id="collapseHistory" class="collapse" aria-labelledby="headingHistory" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="history_claimedDocuments.php">Claimed Documents</a>
            <a class="collapse-item" href="history_unclaimedDocuments.php">Unclaimed Documents</a>
            <a class="collapse-item" href="history_transactions.php">Transactions</a>
        </div>
    </div>
</li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="logout.php" method="POST">
                        <button type="submit" name="logout_btn" class="btn btn-primary" href="login.html">Logout</button>
                    </form>
                </div>
            </div>
        </div>
